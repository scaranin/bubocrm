...
class Customer(models.Model):
    ...
    customershablon = models.ForeignKey(CustomerShablon, verbose_name = 'Шаблон клиента', related_name = 'customers')
...
class CustomerAttrVal(models.Model):
    ...
    customer = models.ForeignKey(Customer, verbose_name = 'Клиент', related_name = 'customerattrvals')
